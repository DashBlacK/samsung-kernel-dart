...
#if defined(CONFIG_MACH_CALLISTO) || defined(CONFIG_MACH_COOPER) || defined(CONFIG_MACH_BENI) || defined(CONFIG_MACH_TASS) || defined(CONFIG_MACH_TASSATT) || defined(CONFIG_MACH_TASSMCT) || defined(CONFIG_MACH_TASSVTR) || defined(CONFIG_MACH_TASSTMO)|| defined(CONFIG_MACH_GT2)|| defined(CONFIG_MACH_FLIPBOOK)|| defined(CONFIG_MACH_LUCAS) || defined(CONFIG_MACH_GIOATT)
...
//    local_irq_save(irq_flags);
 ...
 //   local_irq_restore(irq_flags);
	...
	hi->input->name = "tasstmo_headset";
#elif defined(CONFIG_MACH_TASSMCT)
	hi->input->name = "tassmct_headset";
#elif defined(CONFIG_MACH_TASSVTR)
	hi->input->name = "tassvtr_headset";
#elif defined(CONFIG_MACH_TASSATT)
	hi->input->name = "tassatt_headset";
#elif defined(CONFIG_MACH_GT2)
	hi->input->name = "gt2_headset";
#elif defined(CONFIG_MACH_FLIPBOOK)
	hi->input->name = "flipbook_headset";
...
static struct platform_device h2w_device = {
	...
	.name		= "tass-headset",
#elif defined(CONFIG_MACH_TASSTMO)
	.name		= "tasstmo-headset",
#elif defined(CONFIG_MACH_TASSMCT)
	.name		= "tassmct-headset",
#elif defined(CONFIG_MACH_TASSVTR)
	.name		= "tassvtr-headset",
#elif defined(CONFIG_MACH_TASSATT)
	.name		= "tassatt-headset",
#elif defined(CONFIG_MACH_GT2)
	.name		= "gt2-headset",		
#elif defined(CONFIG_MACH_FLIPBOOK)
	.name		= "flipbook-headset",
#elif defined(CONFIG_MACH_LUCAS)
	.name		= "lucas-headset",	
#elif defined(CONFIG_MACH_EUROPA)
	.name		= "europa-headset",
