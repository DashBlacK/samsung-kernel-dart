...
#endif
#if defined(CONFIG_MACH_CALLISTO) || defined(CONFIG_MACH_BENI) || defined(CONFIG_MACH_TASS) || defined(CONFIG_MACH_TASSMCT) || defined(CONFIG_MACH_TASSVTR) || defined(CONFIG_MACH_TASSTMO)|| defined(CONFIG_MACH_TASSATT)|| defined(CONFIG_MACH_FLIPBOOK) || defined(CONFIG_MACH_LUCAS)
	if ( (strcmp(param, "hw") == 0 ) )
	{
		if (strcmp(val, "1") == 0)
			board_hw_revision = 1;
