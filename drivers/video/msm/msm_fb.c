...
static struct struct_frame_buf_mark  frame_buf_mark = {
	...
	.bpp    = 24,
#endif	
#if defined(CONFIG_MACH_BENI) || defined(CONFIG_MACH_TASS)|| defined(CONFIG_MACH_TASSATT)|| defined(CONFIG_MACH_TASSTMO) || defined(CONFIG_MACH_TASSMCT) || defined(CONFIG_MACH_TASSVTR) 
	.resX   = 256,
	.resY   = 320,
	.bpp    = 18,
#endif	
...
#if defined(CONFIG_MACH_TASS) || defined(CONFIG_MACH_TASSTMO) || defined(CONFIG_MACH_TASSMCT) || defined(CONFIG_MACH_TASSVTR) || defined(CONFIG_MACH_TASSATT) || \
	defined(CONFIG_MACH_FLIPBOOK) || defined(CONFIG_MACH_GT2) || defined(CONFIG_MACH_GIOATT)
...
#if defined(CONFIG_MACH_BENI) || defined(CONFIG_MACH_TASS)|| defined(CONFIG_MACH_TASSATT)|| \
	defined(CONFIG_MACH_TASSTMO)|| defined(CONFIG_MACH_TASSMCT) || defined(CONFIG_MACH_TASSVTR) || defined(CONFIG_MACH_FLIPBOOK) || defined(CONFIG_MACH_GT2) || defined(CONFIG_MACH_GIOATT)
			cur_mfd = mfd;
...
// 20100909 hongkuk.son for COOPER.rle ( booting logo )
...
#if defined(CONFIG_MACH_GIOATT)
	if (!load_565rle_image_onfb( "GIOATT.rle",0,0)) ;	/* Flip buffer */
#endif	
	...
	if (!load_565rle_image_onfb( "TASS_ATT.rle",0,0)) ;	/* Flip buffer */
#endif	
#if defined(CONFIG_MACH_TASSTMO)
	if (!load_565rle_image_onfb( "TASS_TMO.rle",0,0)) ;	/* Flip buffer */
#endif	
#if defined(CONFIG_MACH_TASSMCT)
	if (!load_565rle_image_onfb( "TASS_MCT.rle",0,0)) ;	/* Flip buffer */
#endif	
#if defined(CONFIG_MACH_TASSVTR)
	if (!load_565rle_image_onfb( "TASS_VTR.rle",0,0)) ;	/* Flip buffer */
#endif	
#if defined(CONFIG_MACH_TASSATT)
	if (!load_565rle_image_onfb( "TASS_ATT.rle",0,0)) ;	/* Flip buffer */
#endif	
#if defined(CONFIG_MACH_GT2)
#if defined(CONFIG_MACH_GT2R)
	if (!load_565rle_image_onfb( "GT2R.rle",0,0)) ;	/* Flip buffer */
#else
	if (!load_565rle_image_onfb( "COOPER.rle",0,0)) ;	/* Flip buffer */
#endif	
#endif	
#if defined(CONFIG_MACH_FLIPBOOK)
	if (!load_565rle_image_onfb( "FLIPBOOK_ATT.rle",0,0)) ;	/* Flip buffer */
#endif	
