...
#if defined(CONFIG_MACH_CALLISTO) || defined(CONFIG_MACH_COOPER) || defined(CONFIG_MACH_BENI) || defined(CONFIG_MACH_TASS)|| defined(CONFIG_MACH_TASSTMO)|| defined(CONFIG_MACH_TASSMCT) || defined(CONFIG_MACH_TASSVTR) || defined(CONFIG_MACH_TASSATT)|| defined(CONFIG_MACH_GT2)|| defined(CONFIG_MACH_FLIPBOOK)  || defined(CONFIG_MACH_GIOATT)
	p_line = bits;
...
#elif defined(CONFIG_MACH_BENI) || defined(CONFIG_MACH_TASS)|| defined(CONFIG_MACH_TASSTMO)|| defined(CONFIG_MACH_TASSMCT) || defined(CONFIG_MACH_TASSVTR) || defined(CONFIG_MACH_TASSATT)|| defined(CONFIG_MACH_GT2)
			if(sp == 240)
#endif
			{
				// move next-line
...
#elif defined(CONFIG_MACH_BENI) || defined(CONFIG_MACH_TASS)|| defined(CONFIG_MACH_TASSTMO)|| defined(CONFIG_MACH_TASSMCT) || defined(CONFIG_MACH_TASSVTR) || defined(CONFIG_MACH_TASSATT)
...
int load_565rle_image(char *filename)
{
	...
	lseek_count = (unsigned)sys_lseek(fd, (off_t)0, 2);
	if (lseek_count <= 0) {
		sys_close(fd);
		err = -EIO;
		goto err_logo_close_file;
