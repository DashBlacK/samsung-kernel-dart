...
#elif defined(CONFIG_MACH_COOPER) || defined(CONFIG_MACH_GT2) || defined(CONFIG_MACH_FLIPBOOK) || defined(CONFIG_MACH_GIOATT)    
#define FB_Y_SIZE	480
#elif defined(CONFIG_MACH_LUCAS)
#define FB_Y_SIZE	400
#elif defined(CONFIG_MACH_EUROPA)|| defined(CONFIG_MACH_BENI) || defined(CONFIG_MACH_TASS)|| defined(CONFIG_MACH_TASSTMO)|| defined(CONFIG_MACH_TASSMCT) || defined(CONFIG_MACH_TASSVTR) || defined(CONFIG_MACH_TASSATT)
#define FB_Y_SIZE	320
#endif
static unsigned long fbaddr = 0L;
core_param(fbaddr, fbaddr, ulong, 0444);
//]
