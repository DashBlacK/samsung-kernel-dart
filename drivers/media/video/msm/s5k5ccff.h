...
#define PCAM_SET_FLASH_MODE           19           //shlee_temp Flash
#define PCAM_FLASH_INFO		        25           //shlee_temp Flash
...
//shlee_temp Flash ++
#if 0 
#define PCAM_AF_SET_AE_FOR_FLASH	7
#define PCAM_AF_BACK_AE_FOR_FLASH	8
...
//shlee_temp Flash ++
#define PCAM_FLASH_ON		0
#define PCAM_FLASH_OFF	1
#define PCAM_FLASH_AUTO	2
#define PCAM_FLASH_TURN_ON 3
#define PCAM_FLASH_TURN_OFF 4
#define PCAM_FLASH_TORCH 5 /* SRChoi_110127 for DM cmd - torch */
//shlee_temp Flash --                                                                  
...
s5k5ccff_short_t s5k5ccff_init_60hz[] =
{
//==============================================//
//AFC                                          //
//==============================================//
...
// SRChoi_110303 added pre init
s5k5ccff_short_t s5k5ccff_pre_init0[] =
{
{0xFCFC, 0xD000},
{0x0010, 0x0001},
{0x1030, 0x0000},
...
// History SGH-T589
//===================================================================
// 2010.10.21 : Tuning  - Mirror Change 
// 2011.01.14 : Tuning  - Standard Setting
// 2011.02.07 : Tuning  - MWB
// 2011.02.07 : Report  - DV2
// 2011.02.18 : Tuning  - Flash Delay
// 2011.02.23 : Tuning  - Pre-Flash Delay
// 2011.03.04 : Tuning  - Indoor / Outdoor
// 2011.03.08 : Tuning  - Renewal by DRZ
// 2011.03.30 : Tuning  - iSaturation 7000:0940 = 0x1080 -> 0x1098
// 2011.03.31 : Tuning  - MWB Cloudy & Incandescent
// 2011.03.31 : Tuning  - Flash Delay 700ms(0x2BC) -> 800ms(0x320)
// 2011.04.01 : Tuning  - Renewal by DRZ (일원화 Setting 적용)
//===================================================================

// Start of Trap and Patch -> move to s5k5ccff_pre_init0
...
//===================================================================
// Preview 0 640x480 system 52M PCLK 54M
//===================================================================
{0x002A, 0x023E},
...
{0x0F12, 0x123E},	//awbb_GridConst_2[5]
...
{0x002A, 0x1118},
{0x0F12, 0x0000},	//0032	//awbb_GridCorr_R[0][0] 0050
{0x0F12, 0x0000},	//0012	//awbb_GridCorr_R[0][1] 0032
{0x0F12, 0x0032},	//0012	//awbb_GridCorr_R[0][2] 0032
{0x0F12, 0xFFEC},	//FFEC	//awbb_GridCorr_R[0][3] FFEC
{0x0F12, 0xFFEC},	//FFEC	//awbb_GridCorr_R[0][4] FFEC
{0x0F12, 0x0050},	//0050	//awbb_GridCorr_R[0][5] 0050
{0x0F12, 0x0000},	//0032	//awbb_GridCorr_R[1][0] 0050
{0x0F12, 0x0000},	//0012	//awbb_GridCorr_R[1][1] 0032
{0x0F12, 0x0032},	//0012	//awbb_GridCorr_R[1][2] 0032
{0x0F12, 0xFFEC},	//FFEC	//awbb_GridCorr_R[1][3] FFEC
{0x0F12, 0xFFEC},	//FFEC	//awbb_GridCorr_R[1][4] FFEC
{0x0F12, 0x0050},	//0050	//awbb_GridCorr_R[1][5] 0050
{0x0F12, 0x0000},	//0032	//awbb_GridCorr_R[2][0] 0050
{0x0F12, 0x0000},	//0012	//awbb_GridCorr_R[2][1] 0032
{0x0F12, 0x0032},	//0012	//awbb_GridCorr_R[2][2] 0032
{0x0F12, 0xFFEC},	//FFEC	//awbb_GridCorr_R[2][3] FFEC
{0x0F12, 0xFFEC},	//FFEC	//awbb_GridCorr_R[2][4] FFEC
{0x0F12, 0x0050},	//0050	//awbb_GridCorr_R[2][5] 0050
{0x0F12, 0xFFCE},	//FF9C	//awbb_GridCorr_B[0][0] FF9C
{0x0F12, 0xFFCE},	//FFCE	//awbb_GridCorr_B[0][1] FFD8
{0x0F12, 0xFFEC},	//FFCE	//awbb_GridCorr_B[0][2] FFEC
{0x0F12, 0xFF97},	//FF97	//awbb_GridCorr_B[0][3] FF97
{0x0F12, 0xFF97},	//FF97	//awbb_GridCorr_B[0][4] FF97
{0x0F12, 0xFDA8},	//FDA8	//awbb_GridCorr_B[0][5] FDA8
{0x0F12, 0xFFCE},	//FF9C	//awbb_GridCorr_B[1][0] FF9C
{0x0F12, 0xFFCE},	//FFCE	//awbb_GridCorr_B[1][1] FFD8
{0x0F12, 0xFFEC},	//FFCE	//awbb_GridCorr_B[1][2] FFEC
{0x0F12, 0xFF97},	//FF97	//awbb_GridCorr_B[1][3] FF97
{0x0F12, 0xFF97},	//FF97	//awbb_GridCorr_B[1][4] FF97
{0x0F12, 0xFDA8},	//FDA8	//awbb_GridCorr_B[1][5] FDA8
{0x0F12, 0xFFCE},	//FF9C	//awbb_GridCorr_B[2][0] FF9C
{0x0F12, 0xFFCE},	//FFCE	//awbb_GridCorr_B[2][1] FFD8
{0x0F12, 0xFFEC},	//FFCE	//awbb_GridCorr_B[2][2] FFEC
{0x0F12, 0xFF97},	//FF97	//awbb_GridCorr_B[2][3] FF97
{0x0F12, 0xFF97},	//FF97	//awbb_GridCorr_B[2][4] FF97
...
{0x0F12, 0x0B50},	//70000940  //AFIT8_ccm_oscar_iSaturation[7:0],   AFIT8_RGB2YUV_iYOffset [15:8]
...
{0x0F12, 0x012D},	//0396	//70000C7E	//AFIT8_sddd8a_iRadialLimit [7:0], AFIT8_sddd8a_iRadialPower [15:8]
...
{0x0F12, 0x210C},	//100C	//70000CC4	//AFIT8_sddd8a_iDenThreshHigh[7:0],   AFIT8_Demosaicing_iEdgeDesat [15:8]
...
//shlee_temp Flash ++
s5k5ccff_short_t s5k5ccff_Flash_init[] = { // Setting Unavailable
};

s5k5ccff_short_t s5k5ccff_Pre_Flash_On[] = {
};

s5k5ccff_short_t s5k5ccff_Pre_Flash_Off[] = {
};

s5k5ccff_short_t s5k5ccff_Main_Flash_On[] = {
};

s5k5ccff_short_t s5k5ccff_Main_Flash_Off[] = {
};
//shlee_temp Flash --
...
// SRChoi_110420 added flash snapshot
s5k5ccff_short_t s5k5ccff_flash_high_snapshot[] = 
{
{0xFFFF, 0x0000}, // 0 ms Delay
...
s5k5ccff_short_t s5k5ccff_flash_snapshot[] = 
{
{0xFFFF, 0x0000}, // 0 ms Delay
...
s5k5ccff_short_t s5k5ccff_flash_lowlight_snapshot[] = 
{
{0xFFFF, 0x0000}, // 0 ms Delay
...
{0x0F12, 0x0400},		//REG_SF_USER_Ggain
{0x0F12, 0x0001},		//REG_SF_USER_GgainChanged
{0x0F12, 0x04A8},		//REG_SF_USER_Bgain
{0x0F12, 0x0001},		//REG_SF_USER_BgainChaged
};
...
{0x002A, 0x0504},
{0x0F12, 0x1A0A},	//3415		//lt_uMaxExp1		3415h = 13333d =  33.3325ms
{0x002A, 0x0508},
{0x0F12, 0x1E20},	//3415		//lt_uMaxExp2		3415h = 13333d =  33.3325ms
{0x002A, 0x050C},
...
{0x002A, 0x0514},
{0x0F12, 0x1A0A},		//lt_uCapMaxExp1		3415h = 13333d =  33.3325ms
{0x002A, 0x0518},
{0x0F12, 0x1E20},		//lt_uCapMaxExp2		3415h = 13333d =  33.3325ms
{0x002A, 0x051C},
...
{0x0F12, 0x0480},		//lt_uMaxAnGain3
{0x0F12, 0x0880},		//lt_uMaxAnGain4

{0x0F12, 0x0100},		//lt_uMaxDigGain
{0x0F12, 0x8000},		//lt_uMaxTotGain

{0x0F12, 0x0300},		//lt_uCapMaxAnGain1
{0x0F12, 0x0380},		//lt_uCapMaxAnGain2
{0x0F12, 0x0480},		//lt_uCapMaxAnGain3
{0x0F12, 0x0710},		//lt_uCapMaxAnGain4
...
{0x002A, 0x025A},
{0x0F12, 0x09C4},	//REG_0TC_PCFG_usMaxFrTimeMsecMult10
...
{0x0028, 0x7000}, 
{0x002A, 0x01D6},
{0x0F12, 0x0015},		//REG_TC_UserContrast  //20
};
...
{0x0028, 0x7000}, 
{0x002A, 0x01D6},
{0x0F12, 0x0025},		//REG_TC_UserContrast  //40
};
...
// SRChoi_110211 for flash delay
s5k5ccff_short_t s5k5ccff_flash_delay[] = 
{
{0xFFFF, 0x0}, // move this delay to flash_snapshot
};
#endif
