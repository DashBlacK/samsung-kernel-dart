...
#elif (defined(CONFIG_MACH_BENI) || defined(CONFIG_MACH_TASS) || defined(CONFIG_MACH_TASSTMO)|| defined(CONFIG_MACH_TASSMCT) || defined(CONFIG_MACH_TASSVTR) || defined(CONFIG_MACH_TASSATT) || defined(CONFIG_MACH_FLIPBOOK) || defined(CONFIG_MACH_LUCAS))
   	data[0] = MMC32XX_REG_CTRL;      
		data[1] = MMC32XX_CTRL_RM | MMC32XX_CTRL_NOBOOST;
...
static DEVICE_ATTR(read_mag, S_IRUGO | S_IWUSR | S_IWOTH | S_IXOTH, mmc31xx_fs_read, mmc31xx_fs_write);
static DEVICE_ATTR(power_on, S_IRUGO | S_IWUSR | S_IWOTH | S_IXOTH, mmc31xx_power_on, NULL);
	...
	unsigned int cmd, unsigned long arg)
{
	...
	case MMC31XX_IOC_READXYZ:
		/* [HSS][Cooper] Magnetic sensor change : MMC3140 -> MMC3280 (since REV0.1) */	
#if (defined(CONFIG_MACH_COOPER) || defined(CONFIG_MACH_GIOATT) || defined(CONFIG_MACH_GT2) || defined(CONFIG_MACH_BENI) || defined(CONFIG_MACH_TASS) || defined(CONFIG_MACH_TASSTMO)|| defined(CONFIG_MACH_TASSMCT) || defined(CONFIG_MACH_TASSVTR) || defined(CONFIG_MACH_TASSATT)|| defined(CONFIG_MACH_FLIPBOOK) || defined(CONFIG_MACH_LUCAS))
#if defined(CONFIG_MACH_COOPER) || defined(CONFIG_MACH_GIOATT)  || defined(CONFIG_MACH_GT2)
...
#endif	// (defined(CONFIG_MACH_COOPER) || defined(CONFIG_MACH_BENI) || defined(CONFIG_MACH_TASS) || defined(CONFIG_MACH_TASSTMO)|| defined(CONFIG_MACH_TASSMCT) || defined(CONFIG_MACH_TASSVTR) || defined(CONFIG_MACH_TASSATT)|| defined(CONFIG_MACH_FLIPBOOK) || defined(CONFIG_MACH_LUCAS))
		break;
	default:
		break;
	}
...
/* [HSS] PMIC LDO depends on each model's H/W. */
	...
	if(board_hw_revision < 2)
        ...
        // HW_REV_00 : ldo3 HW_REV_01 : ldo4
	mmc31xx_vreg = vreg_get(0, "ldo4");
#elif defined(CONFIG_MACH_GT2) || defined (CONFIG_MACH_FLIPBOOK)
	// use MSMP2.6V, do not use specific LDO
#else  //GT2
	mmc31xx_vreg = vreg_get(0, "ldo3");
#endif		
...
#elif defined(CONFIG_MACH_COOPER) || defined(CONFIG_MACH_GIOATT)
	if(board_hw_revision < 5) {
		if(vreg_enable(mmc31xx_vreg))
...
{
#if !defined(CONFIG_MACH_GT2) && !defined(CONFIG_MACH_FLIPBOOK)
	struct vreg *mmc31xx_vreg;
