...
#include "Firmware_BENI02_HW04.h"
#elif defined(CONFIG_MACH_TASS)
#include "Firmware_TASS06.h"
#elif defined(CONFIG_MACH_TASSTMO) && (CONFIG_BOARD_REVISION==0x0)
#include "Firmware_TASS06.h"
#elif defined(CONFIG_MACH_TASSTMO) && (CONFIG_BOARD_REVISION>=0x1)
#include "Firmware_TASSTMO_REV01_HW01_SW05.h"
#elif defined(CONFIG_MACH_TASSMCT) && (CONFIG_BOARD_REVISION==0x0)
#include "Firmware_TASS06.h"
#elif defined(CONFIG_MACH_TASSMCT) && (CONFIG_BOARD_REVISION>=0x1)
#include "Firmware_TASSTMO_REV01_HW01_SW05.h"
#elif defined(CONFIG_MACH_TASSVTR) && (CONFIG_BOARD_REVISION==0x0)
#include "Firmware_TASS06.h"
#elif defined(CONFIG_MACH_TASSVTR) && (CONFIG_BOARD_REVISION>=0x1)
#include "Firmware_TASSTMO_REV01_HW01_SW05.h"
#elif defined(CONFIG_MACH_TASSATT)
#include "Firmware_TASS06.h"
#elif defined(CONFIG_MACH_GT2)
#include "Firmware_GT201.h"
#elif defined(CONFIG_MACH_FLIPBOOK)
#include "Firmware_FLIPBOOK01.h"
...
#elif defined(CONFIG_MACH_TASS)
#include "Firmware_TASS02_HW11.h"
#elif defined(CONFIG_MACH_FLIPBOOK)// add_for_realboard_touch_firmware
#include "Firmware_FLIPBOOK01_INNER_HW00_SW02.h"
#endif
};
...
#elif defined(CONFIG_MACH_TASSTMO) && (CONFIG_BOARD_REVISION>=0x1)
#include "Firmware_TASSTMO_REV01_HW04_SW02.h"
#elif defined(CONFIG_MACH_TASSMCT) && (CONFIG_BOARD_REVISION>=0x1)
#include "Firmware_TASSTMO_REV01_HW04_SW02.h"
#elif defined(CONFIG_MACH_TASSVTR) && (CONFIG_BOARD_REVISION>=0x1)
#include "Firmware_TASSTMO_REV01_HW04_SW02.h"
#elif defined(CONFIG_MACH_FLIPBOOK)
#include "Firmware_FLIPBOOK01_OUTER_HW00_SW02.h"
#else
#include "Firmware_cooper0D_HW03.h"
#endif
};
unsigned char Firmware_Data_HW4[]= 
{
#if defined(CONFIG_MACH_TASSTMO) && (CONFIG_BOARD_REVISION>=0x1)
#include "Firmware_TASSTMO_REV04_HW04_SW08.h"
#elif defined(CONFIG_MACH_TASSMCT) && (CONFIG_BOARD_REVISION>=0x1)
#include "Firmware_TASSTMO_REV04_HW04_SW08.h"
#elif defined(CONFIG_MACH_TASSVTR) && (CONFIG_BOARD_REVISION>=0x1)
#include "Firmware_TASSTMO_REV04_HW04_SW08.h"
...
#if defined(CONFIG_MACH_COOPER)|| defined(CONFIG_MACH_GT2)
	if( HW_ver == 3 || HW_ver == 0 )
		pSocData = Firmware_Data_HW3;
#elif defined(CONFIG_MACH_GIOATT)
	if( HW_ver == 1 || HW_ver == 0 )
...
#if !defined(CONFIG_MACH_TASS) && !defined(CONFIG_MACH_TASSTMO)&& !defined(CONFIG_MACH_TASSATT)&& !defined(CONFIG_MACH_GT2)&& !defined(CONFIG_MACH_FLIPBOOK) && !defined(CONFIG_MACH_GIOATT)
