...
void get_usb_serial(char *usb_serial_number)
{
	...
	sprintf(temp_serial_number,"T499%08x",unique_serial_number);
#elif defined(CONFIG_MACH_TASSMCT)
	sprintf(temp_serial_number,"T499Y%08x",unique_serial_number);
#elif defined(CONFIG_MACH_TASSVTR)
	sprintf(temp_serial_number,"T499V%08x",unique_serial_number);
#elif defined(CONFIG_MACH_TASSATT)
	sprintf(temp_serial_number,"I837%08x",unique_serial_number);
#elif defined(CONFIG_MACH_GT2)
	sprintf(temp_serial_number,"T589%08x",unique_serial_number);
#elif defined(CONFIG_MACH_FLIPBOOK)
	sprintf(temp_serial_number,"I857%08x",unique_serial_number);
